        ...
        if (!empty($resultat)) {
            foreach ($resultat as $row) { ?>
                <table class="centrer">
                    <tr>
                        <td>
                            <h2 class="titre"><?php echo $i; ?>. <?php echo $row["pseudo"] ?> : moyenne de <?php echo $row["scorePond"]; ?> point(s), <?php echo $row["scoreTotal"]; ?> point(s) en <?php echo $row["essais"] ?> partie(s).</h2>
                        </td><br>
                    </tr>
                </table>
        <?php
